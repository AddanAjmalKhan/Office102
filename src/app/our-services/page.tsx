...
export default function ourservices() {
  useScrollReveal(".solution__wrapper, .solution__btm, .sec-title-wrapper, .brand__item, .cta__content, .service__list-6 li, .footer__widget, .footer__widget-2, .footer__widget-3, .footer__widget-4, .footer__copyright, .footer__subscribe");
  return (<>
    {/* Hero area start */}
            ...
            <div className="content-wrapper">
              <div className="left-content">
                <ul className="service__list-6">
                  <li className="active"><a href="#service_1">Logo & <br />Branding</a></li>
                  <li><a href="#service_2">Web Design & <br />Development</a></li>
                  <li><a href="#service_3">Ecommerce Store <br />Development</a></li>
                  <li><a href="#service_4">Digital <br /> Maketing</a></li>
                  <li><a href="#service_5">Video <br />Animation</a></li>
                  <li><a href="#service_6">Mobile <br /> Applications</a></li>
                  <li><a href="#service_7">Book <br /> Editing</a></li>
                  <li><a href="#service_8">Book <br /> Formatting</a></li>
                  <li><a href="#service_9">Book <br /> Cover Design</a></li>
                  <li><a href="#service_10">Book <br /> Publishing</a></li>
                  <li><a href="#service_11">Audiobooks</a></li>
                  <li><a href="#service_12">Book <br /> Illustration</a></li>
                  <li><a href="#service_13">Book <br /> Marketing</a></li>
                  <li><a href="#service_14">Author <br /> Branding</a></li>
                </ul>
              </div>
              ...
              <div className="mid-content">
                ...
                <div className="service__image">
                  <img src="assets/imgs/book-editing.png" alt="Service Image" />
                </div>
                <div className="service__image">
                  <img src="assets/imgs/book-formatting.png" alt="Service Image" />
                </div>
                <div className="service__image">
                  <img src="assets/imgs/book-cover-design.png" alt="Service Image" />
                </div>
                <div className="service__image">
                  <img src="assets/imgs/book-publishing.png" alt="Service Image" />
                </div>
                <div className="service__image">
                  <img src="assets/imgs/audiobooks.png" alt="Service Image" />
                </div>
                <div className="service__image">
                  <img src="assets/imgs/book-illustrations.png" alt="Service Image" />
                </div>
                <div className="service__image">
                  <img src="assets/imgs/book-marketing.png" alt="Service Image" />
                </div>
                <div className="service__image">
                  <img src="assets/imgs/author-branding.png" alt="Service Image" />
                </div>
              </div>
              ...
              <div className="right-content">
                <div className="service__items-6">
                  ...
                  <div className="service__item-6" id="service_1" data-secid="1">
                    ...
                    <div>
                      <h2 className="service__title-6 title-anim">We Transform The Right Design Theory Into A Powerful
                        Brand Identity!</h2>
                      <p>Our entire mission is to ensure that your brand comes to life through tailored solutions
                        which amplify and elevate the current market standing of your brand. We offer fast,
                        affordable and hassle-free services. We are able to identify the core targeted audience of
                        your business and build a logo design which assists in appealing effectively. Through our
                        custom logo design and branding services, we will strengthen the overall outlook of your
                        business, provide a platform from which your business can benefit and ensure that overall
                        vision of the business is reflected within the logo.</p>
                  ...
                  <div className="service__item-6" id="service_3" data-secid="3">
                    ...
                    <div>
                      <h2 className="service__title-6 title-anim">We Create Result-Oriented E-Commerce Websites</h2>
                      <p>Our e-commerce services will ensure everything that you need to start booming your business
                        and compete better in today’s extremely rivaled digital marketplaces. From entrepreneurs to
                  ...
                  <div className="service__item-6" id="service_4" data-secid="4">
                    ...
                    <div>
                      <h2 className="service__title-6 title-anim">Let Us Devise a Custom Digital Marketing Strategy That
                        Brings Greater ROI</h2>
                      <p>Our digital marketing services are driven by thorough market research and industry analysis
                        that provide a comprehensive understanding of your business. It helps them identify the key
                        elements and value-additions to swiftly upraise the overall brand reputation. At Infocus
                        Consultancy Group, we plan, develop, and execute discrete digital marketing strategies that
                        bring better search engine rankings, extended target audience reach, and exceptional
                        returns.</p>
                      <p>Whether you want to improve your website’s search engine rankings, boost your keywords on
                        top of the list, and outpace your competitors in today’s digital business environment or
                  ...
                  <div className="service__item-6" id="service_5" data-secid="5">
                    ...
                    <div>
                      ...
                      <p>Office 101 LLC can become your ultimate helping hand if you are striving to
                        ...
                        custom animations, Typographic animations, Whiteboard animations, and Explainer video
                        animations.</p>
                      <p>Sketching exceptional designs is what our professional designers love to do. They
                        understand your target audience, create unique and logical concepts, deliver convincing
                  ...
                  <div className="service__item-6" id="service_8" data-secid="8">
                    ...
                    <div>
                      ...
                      <p>Professional book formatting specialists at Office 101 LLC deliver exceptional craftsmanship by
                        ...
                        publication-ready formatting for every book project.</p>
                  ...
                  <div className="service__item-6" id="service_11" data-secid="11">
                    ...
                    <div>
                      ...
                      <p>Professional audiobook production specialists at Office 101 LLC deliver exceptional craftsmanship
                        ...
                        professional, listener-ready audiobook for every project.</p>
                  ...
                  <div className="service__item-6" id="service_13" data-secid="13">
                    ...
                    <div>
                      ...
                      <p>Professional book marketing specialists at Office 101 LLC deliver exceptional expertise by creating
                        ...
                        book with the right audience everywhere.</p>
                  ...
                  <div className="service__item-6" id="service_14" data-secid="14">
                    ...
                    <div>
                      ...
                      <p>Professional author branding specialists at Office 101 LLC deliver exceptional expertise by
                        ...
                        professional and authentic author brand that resonates with readers everywhere.</p>
    ...
    <section className="brand__area">
      <div className="container g-0 pt-140 pb-140">
    ...
    <section className="cta__area">
      <div className="container pb-110 dark-p">
        <div className="row">
          <div className="col-xxl-12">
            <div className="cta__content" style={{ textAlign: 'center' }}>
              <p className="cta-custom-pill">WORK WITH US</p>
              <h2 className="cta__title" style={{ fontSize: '4rem', marginBottom: '40px', color: '#fff' }}>We would love to hear more <br />about your project</h2>
              <div className="btn_wrapper" style={{ display: 'flex', justifyContent: 'center' }}>
                <a href="/contact-us" className="wc-btn-primary btn-hover btn-item"><span></span>Let’s Talk Now <i
                  className="fa-solid fa-arrow-right" style={{ transform: 'rotate(-45deg)', marginLeft: '8px' }}></i></a>
              </div>
            </div>
          </div>
        </div>
